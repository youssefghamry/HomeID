		...
		public function register_vc_map() {
			...
			vc_map( array(
				...
				'params'   => array(
					...
					array(
						...
						'dependency'       => array(
							'element'            => 'layout_style',
							'value_not_equal_to' => 'property-carousel'
						),
					),
					array(
			...
			vc_map( array(
				...
				'params'   => array(
					...
					array(
						...
						'dependency'       => array(
							'element' => 'layout_style',
							'value'   => array( 'property-cities-filter' )
						)
					),
					array(
						'type'             => 'textfield',
					...
					array(
						...
						'dependency'       => array(
							'element' => 'layout_style',
							'value'   => array( 'property-sync-carousel' )
						)
					),
					array(
						'param_name'       => 'include_heading',
				...
				'params'   => array_merge(
					array(
						...
						array(
							...
							'value'            => array( esc_html__( 'Keyword', 'essential-real-estate' ) => 'true' ),
							'edit_field_class' => 'vc_col-sm-6 vc_column',
							'std'              => 'true',
						),
						array(
						...
						array(
							'type'             => 'checkbox',
							'param_name'       => 'rooms_enable',
							'value'            => array( esc_html__( 'Rooms', 'essential-real-estate' ) => 'true' ),
							'edit_field_class' => 'vc_col-sm-6 vc_column',
						),
						array(
							'type'             => 'checkbox',
			...
			vc_map( array(
				...
				'params'   => array(
					...
					array(
						'type'             => 'checkbox',
						'heading'          => esc_html__( 'Loop', 'essential-real-estate' ),
						'param_name'       => 'loop',
						'dependency'       => array( 'element' => 'layout_style', 'value' => 'agent-slider' ),
						'std'              => '',
						'edit_field_class' => 'vc_col-sm-4 vc_column',
