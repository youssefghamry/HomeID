    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ere-dashboard-content">
        <div class="panel panel-default ere-my-properties">
            ...
            <div class="panel-body">
                <form method="get" action="<?php echo esc_url(get_page_link()) ; ?>" class="ere-my-properties-search">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <select name="property_status" id="property_status" class="form-control"
                                    ...
                                    <option
                                        value="" <?php selected('', $property_status); ?>>
                        ...
                        <div class="ere-post-container">
                            ...
                            <div class="ere-post-content">
                                ...
                                <span class="ere-my-property-address"><i class="fa fa-map-marker"></i>
                                    <?php echo esc_html(get_post_meta($property->ID, ERE_METABOX_PREFIX . 'property_address', true)); ?>
                                    </span>
                                ...
                                <?php echo esc_html(date_i18n(get_option('date_format'), strtotime($property->post_date))) ; ?>
                                </span>
                                <?php
