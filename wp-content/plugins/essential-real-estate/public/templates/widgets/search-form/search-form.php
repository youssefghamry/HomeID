...
$rooms_enable             = ( ! empty( $instance['rooms_enable'] ) ) ? ( $instance['rooms_enable'] ) : '0';
...
echo ere_do_shortcode( 'ere_property_advanced_search', array(
	'layout'                   => $layout,
	'column'                   => 1,
	...
	'rooms_enable'             => $rooms_enable == 1 ? 'true' : 'false',
	'bedrooms_enable'          => $bedrooms_enable == 1 ? 'true' : 'false',
	'bathrooms_enable'         => $bathrooms_enable == 1 ? 'true' : 'false',
	'price_enable'             => $price_enable == 1 ? 'true' : 'false',
	'price_is_slider'          => $price_is_slider == 1 ? 'true' : 'false',
	'area_enable'              => $area_enable == 1 ? 'true' : 'false',
	'area_is_slider'           => $area_is_slider == 1 ? 'true' : 'false',
	'land_area_enable'         => $land_area_enable == 1 ? 'true' : 'false',
	'land_area_is_slider'      => $land_area_is_slider == 1 ? 'true' : 'false',
	'label_enable'             => $label_enable == 1 ? 'true' : 'false',
	'garage_enable'            => $garage_enable == 1 ? 'true' : 'false',
	'property_identity_enable' => $property_identity_enable == 1 ? 'true' : 'false'
) );