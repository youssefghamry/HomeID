...
wp_enqueue_style( ERE_PLUGIN_PREFIX . 'agency');
...
<div class="ere-agency-wrap">
	<div class="<?php echo esc_attr(join( ' ', $wrapper_classes ))  ?>">
		...
		<div class="agency-content">
			<?php if ( $agencies ) :
				foreach ($agencies as $agency) :
					...
					?>
					<div class="<?php echo esc_attr(join( ' ', $agency_item_class )); ?>">
		...
		<?php
		if ( $show_paging == 'true' ) {?>
			<div class="agency-paging-wrap" data-admin-url="<?php echo esc_url(ERE_AJAX_URL) ; ?>"
