...
wp_enqueue_style( ERE_PLUGIN_PREFIX . 'property-type');
?>
<div class="<?php echo esc_attr(join(' ', $wrapper_classes))  ?>">
	<div class="property-type-inner">
		...
		<div class="property-type-info">
			...
			<div class="property-count"><span><?php echo esc_attr( $type_count ); ?></span>
                <?php echo esc_html(_n('Property', 'Properties', $type_count, 'essential-real-estate')); ?>
            </div>
		</div>
	</div>
</div>
