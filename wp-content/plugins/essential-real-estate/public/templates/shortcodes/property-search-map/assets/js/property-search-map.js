var ERE_Property_Search_Map = ERE_Property_Search_Map || {};
(function ($) {
    'use strict';
    ...
    ERE_Property_Search_Map = {
        init: function () {
	        ...
	        if (typeof ($(css_class_wrap).data('options')) !== "undefined") {
		        window['ere_search_map_vars'] = $(css_class_wrap).data('options');
	        }

	        if (typeof (ere_search_map_vars) === "undefined") {
		        return;
	        }


            ajax_url = ere_search_map_vars.ajax_url;
            price_is_slider = ere_search_map_vars.price_is_slider;
            item_amount = ere_search_map_vars.item_amount;
            marker_image_size = ere_search_map_vars.marker_image_size;
            ...
            $('.btn-status-filter', css_class_wrap).on('click', function (e) {
                ...
                ERE_Property_Search_Map.change_price_on_status_change(status);
            });
            ...
            $(".ere-sliderbar-filter.ere-sliderbar-price", css_class_wrap).on('register.again', function () {
                $(".ere-sliderbar-filter.ere-sliderbar-price", css_class_wrap).each(function () {
                    ...
                    ERE_Property_Search_Map.set_slider_filter(slider_filter);
                });
            });
            ...
            $('.other-features-wrap .btn-other-features', css_class_wrap).on('click', function (event) {
                ...
                ERE_Property_Search_Map.search_map('map_and_content');
            });
            $(".ere-sliderbar-filter.ere-sliderbar-price", css_class_wrap).on('register.again', function () {
                $(".ere-sliderbar-filter.ere-sliderbar-price", css_class_wrap).each(function () {
                    var slider_filter = $(this);
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.slide_html) {
                        ...
                        ERE_Property_Search_Map.register_slider_filter();
                        ERE_Property_Search_Map.set_slider_value();
                    }
                    else {
        ...
        property_map_paging: function () {
            ...
            $('.paging-navigation', '.property-search-map-paging-wrap').each(function () {
                $('a', $(this)).off('click').on('click', function (event) {
                    event.preventDefault();
                    var $this = $(this);
                    ERE_Property_Search_Map.search_map('map_and_content', $this);
                });
            });
        },
                    ...
                    if (search_type == 'map_and_content') {
                        ...
                        if (data.success === false) {
                            ...
                            if (window.matchMedia('(max-width: 991px)').matches) {
                                var contentTop1 = $('.property-result-wrap').offset().top - 50;
                            ...
                            ERE.set_item_effect($newElems, 'hide');
                            if (window.matchMedia('(max-width: 991px)').matches) {
                                var contentTop = $('.property-result-wrap').offset().top - 50;
                            ...
                            $property_content.imagesLoaded(function () {
                                ...
                                ERE_Property_Search_Map.property_map_paging();
                                ERE_Property_Search_Map.property_map_paging_control();
                                ERE.favorite();
                                ERE.tooltip();
    ...
    $(window).resize(function () {
        ERE_Property_Search_Map.full_screen();
    });
