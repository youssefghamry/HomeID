	...
	<div class="single-agent-element agent-properties">
		<div class="ere-heading">
			<h2><?php esc_html_e( 'My properties', 'essential-real-estate' ); ?>
				<sub>(<?php echo ere_get_format_number( $total_property ); ?>)</sub></h2>
		</div>
		<?php echo ere_do_shortcode( 'ere_property', array(
			'layout_style' => $property_of_agent_layout_style,
			'item_amount'  => $property_of_agent_items_amount,
			'columns'      => $property_of_agent_column_lg,
