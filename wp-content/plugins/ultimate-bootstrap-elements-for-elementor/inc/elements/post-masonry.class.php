...
class UBE_Element_Post_Masonry extends UBE_Abstracts_Elements {

	public function get_name() {
		return 'ube-post-masonry';
	}

	public function get_title() {
		return esc_html__( 'Post Masonry', 'ube' );
	}
	...
	public function get_script_depends() {
		return array( 'ladda-jquery', 'imagesloaded', 'ube-widget-post', 'ube-widget-post-masonry' );
	}
	...
	public function section_layout() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'post-masonry-layout-01',
				'options' => [
					'post-masonry-layout-01' => esc_html__( 'Post Masonry Layout 01', 'ube' ),
					'post-masonry-layout-02' => esc_html__( 'Post Masonry Layout 02', 'ube' ),
					'post-masonry-layout-03' => esc_html__( 'Post Masonry Layout 03', 'ube' ),
					'post-masonry-layout-04' => esc_html__( 'Post Masonry Layout 04', 'ube' ),
					'post-masonry-layout-05' => esc_html__( 'Post Masonry Layout 05', 'ube' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'      => 'no',
				'condition'    => [
					'post_layout' => 'post-masonry-layout-04',
				],
			]
		);
		$this->add_control(
	...
	public function section_wrapper_style() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ube-posts .ube-post-grid-layout-04 .card-img-overlay' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'post_layout' => 'post-masonry-layout-04',
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ube-post-grid-layout-04 .card-img-overlay' => 'color: {{VALUE}};',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ube-posts .ube-post-grid-layout-04:hover .card-img-overlay' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'post_layout' => 'post-masonry-layout-04',
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ube-post-grid-layout-04:hover .card-img-overlay' => 'color: {{VALUE}};',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ube-posts .card:not(.ube-post-grid-layout-04)' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'post_layout!' => 'post-masonry-layout-04',
				]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ube-posts .ube-post-item,{{WRAPPER}} .ube-posts .ube-post-grid-layout-04 .card-img-overlay',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ube-posts .card-img-overlay' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ube-posts .ube-post-grid-item .card-img-overlay' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			'post_content_v_align_layout_04',
			[
				...
				'toggle'    => true,
				'selectors' => [
					'{{WRAPPER}} .ube-posts .ube-post-grid-layout-04 .card-img-overlay' => 'justify-content: {{VALUE}};',
				],
				'condition' => [
					'post_layout' => 'post-masonry-layout-04',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .ube-posts .ube-post-grid-item .card-img-overlay' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
	...
	public function section_term_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'condition'  => [
					'post_layout!' => 'post-masonry-layout-03',
				],
			]
		);
	...
	public function section_meta_style() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ube-post-grid-layout-04 .ube-posted-day' => 'color: {{VALUE}};',
				],
				'condition' => [
					'post_layout' => 'post-masonry-layout-04'
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ube-posts .ube-entry-meta a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ube-post-grid-layout-04 .ube-posted-day' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
				'separator'  => 'before',
				'condition'  => [
					'post_layout' => 'post-masonry-layout-04'
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .ube-post-grid-layout-04 .ube-posted-day',
				'condition' => [
					'post_layout' => 'post-masonry-layout-04'
				]
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'condition'  => [
					'post_layout!' => 'post-masonry-layout-02',
				],
			]
		);
		$this->add_responsive_control(
	...
	protected function render() {
		ube_get_template( 'elements/post-masonry.php', array(
			'element' => $this
		) );
