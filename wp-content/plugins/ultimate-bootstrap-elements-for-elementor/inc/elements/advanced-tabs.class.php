...
class UBE_Element_Advanced_Tabs extends UBE_Abstracts_Elements {
	public function get_name() {
		return 'ube-advanced-tabs';
	}

	public function get_title() {
		return esc_html__( 'Advanced Tabs', 'ube' );
	}
	...
	public function get_ube_keywords() {
		return array( 'tabs', 'advanced tabs', 'ube', 'ube advanced tabs' );
	}
	...
	private function section_header_items_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ube-tabs .tab-content .ube-tabs-card:not(.active) .ube-tabs-card-header:not(:hover)' => 'background-color: {{VALUE}}!important',
				],
				'condition' => [
					'tab_type' => [ 'flat', 'classic', 'pills' ],
				]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ube-tabs .nav .nav-item,{{WRAPPER}} .ube-tabs .tab-content .ube-tabs-card-header',
			]
		);
	...
	protected function render() {
		ube_get_template( 'elements/adv-tabs.php', array(
			'element' => $this
		) );
	}
}