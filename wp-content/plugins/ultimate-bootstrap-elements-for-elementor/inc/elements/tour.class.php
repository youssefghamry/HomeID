...
class UBE_Element_Tour extends UBE_Abstracts_Elements {
	public function get_name() {
		return 'ube-tour';
	}

	public function get_title() {
		return esc_html__( 'Tour', 'ube' );
	}
	...
	public function get_ube_keywords() {
		return array( 'tour', 'tabs', 'ube', 'ube tour' );
	}
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ube-tour-flat .tab-content .ube-tabs-card .ube-tabs-card-title'           => 'color: {{VALUE}}!important;',
				],
				'condition' => [
	...
	private function section_header_items_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' =>
					'{{WRAPPER}} .ube-tour .nav-link,{{WRAPPER}} .ube-tabs-card-header .ube-tabs-card-title',
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .ube-tour .tab-content.ube-tab-separate .tab-pane:not(:last-child)'     => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'conditions' => [
					'relation' => 'or',
					'terms'    => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ube-tour .tab-content .ube-tabs-card:not(.active):not(:hover) .ube-tabs-card-header' => 'background-color: {{VALUE}}!important',
				],
				'condition' => [
					'tab_type' => [ 'flat', 'classic', 'pills' ],
				]
		...
		$this->add_responsive_control(
			...
			[
				...
				'condition' => [
					'tab_type' => [ 'flat', 'pills', 'classic', 'outline' ],
				]
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ube-tour .nav-tabs .nav-link.active .tab-icon path'         => 'stroke: {{VALUE}}; fill: {{value}}',
					'{{WRAPPER}} .ube-tour .tab-content .ube-tabs-card.active .tab-icon path' => 'stroke: {{VALUE}}; fill: {{value}}'
				],
				'condition' => [
					'tab_title_type_icon' => 'yes',
				],
	...
	private function section_body_style() {
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(), [
				...
				'selector' => '{{WRAPPER}} .ube-tour .tab-content .ube-tabs-card-body',
			]
		);
		$this->add_responsive_control(
			'tab_body_color',
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ube-tour .tab-content .ube-tabs-card-body' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					//'{{WRAPPER}} .ube-tour .tab-content .ube-tabs-card.active'            => 'background-color: {{VALUE}}!important;',
				],
				'conditions' => [
					'relation' => 'and',
					'terms'    => [
	...
	protected function render() {
		ube_get_template( 'elements/tour.php', array(
			'element' => $this
		) );
	}
}