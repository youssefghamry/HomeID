...
class UBE_Element_Post_Grid extends UBE_Abstracts_Elements {

	public function get_name() {
		return 'ube-post-grid';
	}

	public function get_title() {
		return esc_html__( 'Post Grid', 'ube' );
	}
	...
	public function section_layout() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'post-grid-layout-01' => esc_html__( 'Post Grid Layout 01', 'ube' ),
					'post-grid-layout-02' => esc_html__( 'Post Grid Layout 02', 'ube' ),
					'post-grid-layout-03' => esc_html__( 'Post Grid Layout 03', 'ube' ),
					'post-grid-layout-04' => esc_html__( 'Post Grid Layout 04', 'ube' ),
				],
			]
		);
	...
	protected function render() {
		ube_get_template( 'elements/post-grid.php', array(
			'element' => $this
		) );
