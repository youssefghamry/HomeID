...
<?php if (isset($settings['pricing_table_image']) && $settings['pricing_table_icon_type'] == 'image'): ?>
	...
	<?php endif; ?>
<?php endif; ?>
<?php if ($settings['pricing_table_price_position'] === 'top'): ?>
	<div class="ube-pricing-tag on-top">
		<span class="ube-pricing-price-tag"><?php $element->render_pricing($settings); ?></span>
		<span class="ube-pricing-price-period"><?php echo $settings['pricing_table_period_separator']; ?><?php echo $settings['pricing_table_price_period']; ?></span>
	</div>
<?php endif; ?>
...
<?php if ($settings['pricing_table_price_position'] === 'bottom'): ?>
