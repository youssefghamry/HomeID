...
$element->add_render_attribute( 'nav_wrapper_attr', array(
	'class' => $nav_classes,
	'role'  => 'tablist'
) );
$tab_content_classes = array( 'tab-content' );
...
<div <?php echo $element->get_render_attribute_string( 'tabs_wrapper_class' ); ?>>
    <div class="tabs">
        <ul <?php echo $element->get_render_attribute_string( 'nav_wrapper_attr' ); ?>>
			<?php
