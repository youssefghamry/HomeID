...
return array(
	'base' => 'g5element_properties_carousel',
	'name' => esc_html__('Properties Carousel', 'g5-ere'),
	'category' => G5ERE()->shortcodes()->get_category_name(),
	'icon'        => 'g5element-vc-icon-properties-carousel',
	'description' => esc_html__( 'Display carousel of properties', 'g5-ere' ),
	'params' => array_merge(
		array(
			array(
