...
return array(
	'base'        => 'g5element_agency',
	'name'        => esc_html__( 'Agency', 'g5-ere' ),
	'category'    => G5ERE()->shortcodes()->get_category_name(),
	'icon'        => 'g5element-vc-icon-properties',
	'description' => esc_html__( 'Display list of agency', 'g5-ere' ),
	'params'      => array_merge(
		array(
			array(
				'param_name'  => 'post_layout',
				'heading'     => esc_html__( 'Agency Layout', 'g5-ere' ),
				'description' => esc_html__( 'Specify your agency layout', 'g5-ere' ),
				'type'        => 'g5element_image_set',
				'value'       => G5ERE()->settings()->get_agency_layout(),
				'std'         => 'grid',
				'admin_label' => true
			),
			array(
			...
			array(
				...
				'description' => esc_html__( 'Specify your agency item skin', 'g5-ere' ),
				'type'        => 'g5element_image_set',
				'value'       => G5ERE()->settings()->get_agency_list_skins(),
				'std'         => 'skin-list-01',
				'admin_label' => true,
			...
			array(
				...
				'heading'     => esc_html__( 'Agency Columns Gutter', 'g5-ere' ),
			...
			array(
				...
				'description' => esc_html__( 'Specify your agency paging mode', 'g5-ere' ),
				'type'        => 'dropdown',
