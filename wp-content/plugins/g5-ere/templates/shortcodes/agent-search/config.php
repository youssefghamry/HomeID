...
return array(
	'base'        => 'g5element_agent_search',
	'name'        => esc_html__( 'Agent Search', 'g5-ere' ),
	'category'    => G5ERE()->shortcodes()->get_category_name(),
	'icon'        => 'g5element-vc-icon-agent-search',
	'description' => esc_html__( 'Display agent search form', 'g5-ere' ),
	'params'      => array_merge(
		array(
