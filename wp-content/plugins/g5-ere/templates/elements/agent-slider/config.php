...
class UBE_Element_G5ERE_Agent_Slider extends G5ERE_Abstracts_Elements_Listing_Agent {
	...
	public function get_name() {
		return 'g5-agent-slider';
	}

	public function get_title() {
		return esc_html__( 'G5 Agent Slider', 'g5-ere' );
	}
	...
	public function get_script_depends() {
		return array(G5ERE()->assets_handle('agent-slider'));
	}

	public function get_ube_keywords() {
		return array('agent', 'agent slider', 'cpt', 'item', 'loop', 'query', 'cards', 'custom post type','ube','g5');
	}

	public function render() {
		G5ERE()->get_template( 'elements/agent-slider/template.php', array(
			'element' => $this
		) );
	}
