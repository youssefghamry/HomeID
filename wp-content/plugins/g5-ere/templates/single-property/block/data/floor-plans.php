            ...
            <div class="card g5ere__property_floors-item border-0">
                <div class="card-header"
                    ...
                    <div class="g5ere__property_floors-item-heading d-flex justify-content-between align-items-center"
                         data-toggle="collapse" data-target="#g5ere__floor-<?php echo esc_attr( $index ); ?>"
                         aria-expanded="<?php if ( $index === 0 ): ?> true<?php else: ?>false <?php endif; ?>"
                         aria-controls="g5ere__floor-<?php echo esc_attr( $index ); ?>" role="button">
                ...
                <div id="g5ere__floor-<?php echo esc_attr( $index ); ?>"
                     class="collapse <?php if ( $index === 0 ): ?>show<?php endif; ?>"
                     aria-labelledby="g5ere__floor-title-<?php echo esc_attr( $index ); ?>"
                     data-parent="#g5ere__property_floors_accordion">
                    <div class="card-body">
						<?php if ( ! empty( $image_src ) ): ?>
                            <div class="g5ere__property-floor-image">
                                <a data-g5core-mfp="true"
                                   data-mfp-options='<?php echo esc_attr( json_encode( $args ) ) ?>'
