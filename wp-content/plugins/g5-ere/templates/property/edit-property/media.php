            ...
            <div class="ere-property-gallery">
                <div class="media-gallery">
                    <div id="property_gallery_thumbs_container" class="row">
						<?php
						$property_images = get_post_meta( $property_data->ID, ERE_METABOX_PREFIX . 'property_images', true);
                    ...
                    <div class="property-image-360 col-sm-6 form-group">
                        ...
                        <div id="ere_image_360_plupload_container" class="file-upload-block">
                            <div class="input-group">
                                <input
                                        ...
                                        type="text"
                                        id="image_360_url"
                                        class="ere_image_360_url form-control"
                                        value="<?php echo esc_url( $property_image_360_url ); ?>">
                                <div class="input-group-append">
                                    <span id="ere_select_images_360"
                                          title="<?php esc_attr_e( 'Choose image', 'g5-ere' ) ?>"
                                          class="ere_image360 input-group-text position-relative"><i
						...
						<?php if ( ! empty( $property_image_360_url ) ): ?>
                            <div id="ere_property_image_360_view" class="mt-3"
                                ...
                                <iframe width="100%" height="200" scrolling="no" allowfullscreen
                                        src="<?php echo ERE_PLUGIN_URL . "public/assets/packages/vr-view/index.html?image=" . esc_url( $property_image_360_url ); ?>"></iframe>
                            </div>
						<?php endif; ?>
                    </div>
				<?php endif; ?>
