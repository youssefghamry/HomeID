...
<div class="<?php echo esc_attr($wrapper_class)?>">
	...
	<select id="<?php echo esc_attr($prefix)?>_state" data-toggle="g5ere__select_location_filter" data-hide-disabled="true" data-target=".g5ere__sf-city" name="state" class="form-control selectpicker" data-live-search="true">
