...
$content_block_enable = g5ere_get_single_agency_tabs_content_blocks();

if ( ! $content_block_enable ) {
	return;
}
?>
<div class="g5ere__single-block g5ere__single-block-tabs g5ere__agency-block g5ere__single-agency-tabs">
	...
	<div class="tab-content g5ere__panels-container">
		...
		<?php foreach ( $content_block_enable as $key => $tab ) : ?>
			<div class="tab-pane fade <?php echo esc_attr( $index === 0 ? 'show active' : '' ) ?>"
				...
				<div class="g5ere__tab-panel card g5ere__single-block g5ere__agency-block g5ere__agency-block-<?php echo esc_attr($key) ?>">
					...
					<div id="collapse-<?php echo esc_attr( $key ); ?>"
						...
						<div class="g5ere__panel-body card-body">
							<?php G5ERE()->get_template( "agency/single/block/data/{$key}.php", array( 'block_name' => $tab ) ) ?>
						</div>
					</div>
				</div>
			</div>
