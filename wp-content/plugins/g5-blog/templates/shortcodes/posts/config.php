...
return array(
    ...
    'name' => esc_html__('Posts', 'g5-blog'),
    'description' => esc_html__( 'Display list of posts', 'g5-blog' ),
    'category' => G5ELEMENT()->shortcode()->get_category_name(),
    'icon'        => 'g5element-vc-icon-posts',
    'params' => array_merge(
        array(
            array(
            ...
            array(
                ...
                'value' => G5BLOG()->settings()->get_shortcode_post_layout(),
                'std' => 'grid',
                'admin_label' => true
            ),
	        array(
            ...
            array(
                ...
                'description' => esc_html__('Specify your horizontal space between post.', 'g5-blog'),
                'type' => 'dropdown',
                'value' => array_flip(G5CORE()->settings()->get_post_columns_gutter()),
                'std' => '30',
                'dependency' => array('element' => 'post_layout', 'value' => G5BLOG()->settings()->get_post_layout_has_columns()),
            ),
            array(
                'param_name' => 'posts_per_page',
                'heading' => esc_html__('Posts Per Page', 'g5-blog'),
                'description' => esc_html__('Enter number of posts per page you want to display. Default 10', 'g5-blog'),
            ...
            array(
                ...
                'heading' => esc_html__('Post Paging', 'g5-blog'),
                'description' => esc_html__('Specify your post paging mode', 'g5-blog'),
                'type' => 'dropdown',
        ...
        g5element_vc_map_add_columns(array(
            'element' => 'post_layout',
            'value' => G5BLOG()->settings()->get_post_layout_has_columns()
        ), esc_html__('Columns', 'g5-blog')),
        array(
            array(
            ...
            array(
                ...
                'heading' => esc_html__('Image Width', 'g5-blog'),
                'type' => 'g5element_number',
                'std' => '400',
