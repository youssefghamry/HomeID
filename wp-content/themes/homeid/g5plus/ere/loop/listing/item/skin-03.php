		...
		<?php if ( $thumbnail_data['url'] !== '' ): ?>
			<div class="g5core__post-featured g5ere__property-featured g5ere__post-featured-bg-gradient">
				<?php g5ere_render_property_thumbnail_markup( array(
					...
					<?php
					/**
					 * Hook: g5ere_after_loop_property_thumbnail_skin_03.
					 *
					 * @hooked g5ere_template_loop_property_featured_status - 10
					 */
					do_action('g5ere_after_loop_property_thumbnail_skin_03');
					?>
					<div class="g5ere__loop-property-actions g5ere__lpa-rounded g5ere__lpa-top-right">
						<?php
						/**
						 * Hook: g5ere_loop_property_action_skin_03
						 *
						 * @hooked g5ere_template_loop_property_action_favorite - 5
						 * @hooked g5ere_template_loop_property_action_compare - 10
						 *
						 */
						do_action('g5ere_loop_property_action_skin_03');
						?>
					</div>
					<div class="g5ere__property-content g5ere__loop-content">
						<?php
						/**
						 * Hook: g5ere_loop_property_content_skin_03
						 *
						 ...
						 */
						do_action('g5ere_loop_property_content_skin_03');
						?>
					</div>
				</div>
		<?php endif; ?>
