...
<article <?php post_class( $post_class ) ?> <?php echo join(' ', $post_attributes)?>>
	<div <?php echo join( ' ', $post_inner_attributes ) ?> class="<?php echo esc_attr( $post_inner_class ); ?>">
		<div class="g5ere__property-content-top">
			<?php
			/**
			 * Hook: g5ere_before_loop_property_thumbnail_skin_07.
			 *
			 * @hooked g5ere_template_loop_property_title - 5
			 * @hooked g5ere_template_loop_property_address - 10
			 */
			do_action('g5ere_before_loop_property_thumbnail_skin_07')
			?>
		</div>
		<?php if ( $thumbnail_data['url'] !== '' ): ?>
			<div class="g5core__post-featured g5ere__property-featured">
				 ...
				 */
				do_action('g5ere_after_loop_property_thumbnail_skin_07');
				?>
			</div>
		<?php endif; ?>
		<div class="g5ere__property-content g5ere__loop-content">
			<div class="g5ere__lpc-top d-flex flex-wrap align-items-center justify-content-between">
				<?php
				/**
				 * Hook: g5ere_loop_property_content_top_skin_07.
				 *
				 * @hooked g5ere_template_loop_property_price - 5
				 * @hooked g5ere_template_loop_property_primary_status - 10
				 */
				do_action('g5ere_loop_property_content_top_skin_07');
				?>
			</div>
			<div class="g5ere__lpc-center">
				<?php
				/**
				 * Hook: g5ere_loop_property_content_skin_07.
				 *
				 * @hooked g5ere_template_loop_property_excerpt - 5
				 */
				do_action('g5ere_loop_property_content_skin_07')
				?>
			</div>
			<div class="g5ere__lpc-bottom">
				<?php
				/**
				 * Hook: g5ere_loop_property_content_bottom_skin_07.
				 *
				 * @hooked g5ere_template_loop_property_meta - 5
				 */
				do_action('g5ere_loop_property_content_bottom_skin_07');
				?>
			</div>
		</div>
	</div>
