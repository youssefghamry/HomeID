	...
	<div <?php echo join( ' ', $post_inner_attributes ) ?> class="<?php echo esc_attr( $post_inner_class ); ?>">
		<?php if ( $thumbnail_data['url'] !== '' ): ?>
			<div class="g5core__post-featured g5ere__property-featured g5ere__post-featured-bg-gradient">
				...
				<?php
				/**
				 * Hook: g5ere_after_loop_property_thumbnail_skin_04.
				 *
				 * @hooked g5ere_template_loop_property_badge - 5

				 */
				do_action('g5ere_after_loop_property_thumbnail_skin_04');
				?>
				<div class="g5ere__loop-property-actions g5ere__lpa-white g5ere__lpa-rounded g5ere__lpa-center g5ere__lpa-lg">
					<?php
					/**
					 * Hook: g5ere_after_loop_property_action_skin_04.
					 *
					 * @hooked g5ere_template_loop_property_action_favorite - 5
					 * @hooked g5ere_template_loop_property_action_compare - 10
					 */
					do_action('g5ere_after_loop_property_action_skin_04');
					?>
				</div>
				<div class="g5ere__property-content g5ere__loop-content">
					<?php
					/**
					 * Hook: g5ere_after_loop_property_thumbnail_content_skin_04.
					 *
					 * @hooked g5ere_template_loop_property_meta - 5
					 */
					do_action('g5ere_after_loop_property_thumbnail_content_skin_04');
					?>
				</div>
			</div>
		<?php endif; ?>
		<div class="g5ere__property-content g5ere__loop-content">
			<?php
			/**
			 * Hook: g5ere_loop_property_content_skin_04.
			 *
			 ...
			 */
			do_action('g5ere_loop_property_content_skin_04');
			?>
		</div>
	</div>
</article>
