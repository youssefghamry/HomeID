	...
	<div <?php echo join( ' ', $post_inner_attributes ) ?> class="<?php echo esc_attr( $post_inner_class ); ?>">
		<?php if ( $thumbnail_data['url'] !== '' ): ?>
			<div class="g5core__post-featured g5ere__property-featured">
				...
				<?php
				/**
				 * Hook: g5ere_after_loop_property_thumbnail_skin_list_03
				 *
				 * @hooked g5ere_template_loop_property_action - 5
				 * @hooked g5ere_template_loop_property_badge - 10
				 */
				do_action('g5ere_after_loop_property_thumbnail_skin_list_03');
				?>
			</div>
		<?php endif; ?>
		<div class="g5ere__property-content g5ere__loop-content d-flex flex-column justify-content-between">
			<div class="g5ere__lpc-top">
				<?php
				/**
				 * Hook: g5ere_loop_property_content_skin_list_03.
				 *
				 ...
				 */
				do_action('g5ere_loop_property_content_skin_list_03');
				?>
			</div>
			<div class="g5ere__lpc-bottom d-flex flex-wrap align-items-center justify-content-between">
				 ...
				 */
				do_action('g5ere_loop_property_content_bottom_skin_list_03');
				?>
			</div>
		</div>
	</div>
