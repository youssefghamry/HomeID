...
$post_inner_class = str_replace('g5ere__loop-item-inner','',$post_inner_class);
?>
<article <?php post_class( $post_class ) ?> <?php echo join(' ', $post_attributes)?>>
	<div <?php echo join( ' ', $post_inner_attributes ) ?> class="<?php echo esc_attr( $post_inner_class ); ?>">
		...
		<div class="g5ere__lpc-top g5ere__loop-item-inner">
			<?php if ( $thumbnail_data['url'] !== '' ): ?>
				<div class="g5core__post-featured g5ere__property-featured">
					...
					<div class="g5ere__loop-property-actions g5ere__lpa-white g5ere__lpa-rounded g5ere__lpa-center">
						<?php
						/**
						 * Hook: g5ere_after_loop_property_thumbnail_skin_list_02.
						 *
						 * @hooked g5ere_template_loop_property_action_favorite - 5
						 * @hooked g5ere_template_loop_property_action_compare - 10
						 */
						do_action('g5ere_after_loop_property_thumbnail_skin_list_02');
						?>
					</div>
				</div>
			<?php endif; ?>
			<div class="g5ere__property-content g5ere__loop-content">
				<?php
				/**
				 * Hook: g5ere_loop_property_content_skin_list_02.
				 *
				 ...
				 */
				do_action('g5ere_loop_property_content_skin_list_02');
				?>
			</div>
		</div>
		<div class="g5ere__lpc-bottom d-flex flex-wrap align-items-center justify-content-between">
			<?php
			/**
			 * Hook: g5ere_loop_property_content_bottom_skin_list_02.
			 *
			 * @hooked g5ere_template_loop_property_meta - 5
			 * @hooked g5ere_template_loop_property_primary_status - 10
			 */
			do_action('g5ere_loop_property_content_bottom_skin_list_02');
			?>
		</div>
	</div>
</article>
