		...
		<?php if ($thumbnail_data['url'] !== ''): ?>
            <div class="g5core__post-featured g5ere__agent-featured">
                ...
                <div class="g5ere__agent-content">
					<?php
					/**
					 * Hook: g5ere_loop___agent_after_thumbnail_skin_list_02.
					 *
					 * @see g5ere_template_loop__agent_button_load_more - 5
					 */
					do_action('g5ere_loop___agent_after_thumbnail_skin_list_02');
					?>
                </div>
            </div>
		<?php endif; ?>
        <div class="g5ere__agent-content arrow-box">
			<?php
			/**
			 * Hook: g5ere_loop___agent_content_skin_list_02.
			 *
			 ...
			 * @see g5ere_template_loop_agent_social - 20
			 */
			do_action('g5ere_loop___agent_content_skin_list_02');
			?>
        </div>
    </div>
</article>
