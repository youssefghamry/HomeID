...
<article <?php post_class( $post_class ) ?>>
	<div <?php echo join( ' ', $post_inner_attributes ) ?> class="<?php echo esc_attr( $post_inner_class ); ?>">
		...
		<div class="g5ere__agent-content">
			<?php
			/**
			 * Hook: g5ere_loop__agent_content_skin_02.
			 *
			 ...
			 */
			do_action( 'g5ere_loop__agent_content_skin_02' );
			?>
		</div>
		<div class="g5ere__agent-bottom">
			<?php
			/**
			 * Hook: g5ere_loop__agent_bottom_skin_02.
			 *
			 * @see g5ere_template_loop_agent_social - 5
			 */
			do_action( 'g5ere_loop__agent_bottom_skin_02' );
			?>
		</div>
	</div>
</article>
