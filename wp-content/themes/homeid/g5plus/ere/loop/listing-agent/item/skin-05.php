...
<article <?php post_class($post_class) ?>>
    <div <?php echo join(' ', $post_inner_attributes) ?> class="<?php echo esc_attr($post_inner_class); ?>">
        <div class="g5ere__agent-top">
			...
			<?php
			/**
			 * Hook: g5ere_loop__agent_top_skin_05.
			 *
			 ...
			 */
			do_action('g5ere_loop__agent_top_skin_05');
			?>
        </div>
        <div class="g5ere__agent-content">
			<?php
			/**
			 * Hook: g5ere_loop__agent_content_skin_05.
			 *
			 * @see g5ere_template_loop_agent_office_number_has_title - 5
			 * @see g5ere_template_loop_agent_phone_has_title - 10
			 * @see g5ere_template_loop_agent_fax_has_title - 15
			 * @see g5ere_template_loop_agent_email_has_title - 20
			 * @see g5ere_template_loop_agent_social_has_title - 25
			 */
			do_action('g5ere_loop__agent_content_skin_05');
			?>
        </div>
    </div>
</article>
