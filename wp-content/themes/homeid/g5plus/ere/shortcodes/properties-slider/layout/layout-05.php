	...
	<div <?php echo join( ' ', $post_inner_attributes ) ?> class="<?php echo esc_attr($post_inner_class)?>">
		<div class="container">
			<div class="g5ere__psi-content">
				<?php
				/**
				 * Hook: g5ere_loop_property_slider_content_layout_05.
				 *
				 ...
				 */
				do_action('g5ere_loop_property_slider_content_layout_05');
				?>
				<div class="g5ere__property-bottom">
					<?php
					/**
					 * Hook: g5ere_loop_property_slider_bottom_layout_05.
					 *
					 ...
					 */
					do_action('g5ere_loop_property_slider_bottom_layout_05');
					?>
				</div>
			</div>
		</div>
