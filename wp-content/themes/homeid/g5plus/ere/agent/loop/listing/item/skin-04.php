...
$post_class .= ' g5ere__loop-skin-classic g5ere__loop-agent-social-classic';
$post_inner_class .= ' g5ere__li-bordered g5ere__li-hover-box-shadow bg-white text-center';
?>
	...
	<div <?php echo join(' ', $post_inner_attributes) ?> class="<?php echo esc_attr($post_inner_class); ?>">
		...
		<div class="g5ere__agent-content g5ere__loop-content">
			<div class="g5ere__lac-top">
				<?php
				/**
				 * Hook: g5ere_loop_agent_content_top_skin_04.
				 *
				 * @see g5ere_template_loop_agent_title
				 * @see g5ere_template_loop_agent_position
				 * @see g5ere_template_loop_agent_social
				 */
				do_action('g5ere_loop_agent_content_top_skin_04');
				?>
			</div>
			<?php
			/**
			 * Hook: g5ere_loop_agent_content_skin_04.
			 *
			 ...
			 */
			do_action('g5ere_loop_agent_content_skin_04');
			?>
		</div>
	</div>
</article>
